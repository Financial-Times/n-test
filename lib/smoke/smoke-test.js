...
class SmokeTest {
	...
	async displayResults (puppetResults, crossBrowserResults, timeTaken, expectedTestCount) {
		...
		console.log('----------------------------');
		console.log(pc`{bold.underline Smoke Test Results}`);
		console.log(pc`{bgBlue URLs tested:} ${totalResults.urlsTested}`);
		console.log(pc`{bgGreen Passed:} ${totalResults.passed.length}`);
		console.log(pc`{bgRed Failed:} ${totalResults.failed.length}`);
		console.log(pc`{bgRedBright Missed:} ${totalResults.missed}`);
		console.log(pc`{bgMagentaBright Errors:} ${totalResults.errors.length}`);
		console.log(pc`{bgYellowBright Time Taken:} ${timeTaken}s`);
		console.log('--------------------------------');
