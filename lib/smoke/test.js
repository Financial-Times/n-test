		...
		Object.keys(conf.urls).forEach(url => {
			...
			describe(url, () => {
				...
				beforeAll(async () => {
					...
					response = await page.goto(fullUrl, { waitUntil: 'load'});
				...
				if(typeof test.pageErrors !== 'undefined') {
					it(`should have no more than ${test.pageErrors} console errors`, () => {
						// eslint-disable-next-line no-console
						console.info('Errors in Console: ', pageErrors);
